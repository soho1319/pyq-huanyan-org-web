...
// 4 预设主题 → 7 维度占比（D55 彻底切到 dim）
const PRESET_WEIGHTS: Record<string, Record<string, number>> = {
  // 信任月：B 客户 + G 互动 + F 复盘 占比高
  trust:    { A: 0.05, B: 0.25, C: 0.15, D: 0.05, E: 0.10, F: 0.10, G: 0.30 },
  // 专业月：B 专业 + F 思想 占比高
  pro:      { A: 0.05, B: 0.35, C: 0.10, D: 0.10, E: 0.05, F: 0.30, G: 0.05 },
  // 销售月：C 情绪（软广）+ G 关系 占比高
  sale:     { A: 0.10, B: 0.15, C: 0.30, D: 0.05, E: 0.10, F: 0.20, G: 0.10 },
  // 恢复月：E 生活 + A 观赏 占比高
  recovery: { A: 0.25, B: 0.10, C: 0.10, D: 0.10, E: 0.25, F: 0.10, G: 0.10 },
}
